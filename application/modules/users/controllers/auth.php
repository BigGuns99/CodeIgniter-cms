  ...
  function _render_page($view, $data = null, $render = false)
    {
        ...
        if ($view == 'auth/login' OR $view == 'auth/forgot_password') {
            $themeBase = $this->config->item('theme_path');
        }else{
            $themeBase = $this->config->item('admin_theme_path');
        }
      
        $view_html = $this->load->view($themeBase, $this->data, $render);
        if (!$render)
            return $view_html;
    }
